  ...
  const fetchProject = async () => {
    ...
    setTimeout(() => {
      if (foundProject) {
        setProject({
          ...foundProject,
          conversation: dummyConversations,versions:dummyVersion
        })
    ...
    <div className="flex flex-col h-screen w-full bg-gray-900 text-white">
      ...
      <div className="flex max-sm:flex-col sm:items-center gap-4 px-4 py-2">
        ...
        <div className="flex items-center justify-end gap-3 flex-1 text-xs sm:text-sm">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="max-sm:hidden bg-gray-800 hover:bg-gray-700 px-3.5 py-1 flex items-center gap-2 rounded border border-gray-700 transition-colors"
          >
            {isSaving ? (
          ...
          <Link
            ...
            className="flex items-center gap-2 px-4 py-1 rounded border border-gray-700 hover:border-gray-50 transition-colors"
          >
      ...
      <div className="flex-1 flex overflow-auto">
        ...
        <div className="flex-1 p-2 pl-0">
          <ProjectPreview ref={previewRef} project={project} isGenerating=
          {isGenerating} device={device}/>
        </div>
      </div>
    </div>
  ) : (
